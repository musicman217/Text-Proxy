...
class HDVILAVideoRetrievalDataset(Dataset):
    ...
    def id2path(self, id):
        ...
        if self.vis_format == 'video':
            name = os.path.join(self.vis_dir, clip_name + ".mp4") # clip_name.split('/')[-1]+".mp4") # .../3fps_video/ +
    ...
    def get_sample_idx(self, total_frame_num):
        ...
        if self.sample_rate > 0:
            ...
            if hasattr(self.cfg, "sample_jitter") and self.cfg.sample_jitter and self.mode == "train":  # sample_jitter = 1
